/*------------------------------------------------------------------------------
-------------------  CASE STUDY 1 (Getting Data into SAS) ----------------------
-------------------------------------------------------------------------------*/

filename flights 	'/folders/myfolders/CaseStudy/SAS Master Case study 1/flights.csv';
filename planes		'/folders/myfolders/CaseStudy/SAS Master Case study 1/planes.csv';
filename weather 	'/folders/myfolders/CaseStudy/SAS Master Case study 1/weather.csv' encoding='utf-8';
filename airlines 	'/folders/myfolders/CaseStudy/SAS Master Case study 1/airlines.csv';
